...
const HistoryViewerFixed: React.FC<HistoryViewerProps> = ({ onRestoreState }) => {
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid w-full grid-cols-2">
                ...
                {selectedSessionId && (
                  <TabsTrigger value="session">Selected Session</TabsTrigger>
                )}
              </TabsList>
...
export default HistoryViewerFixed;
